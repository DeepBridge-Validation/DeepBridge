...
for i in range(0, len(X_sorted) - WINDOW_SIZE + 1, STEP_SIZE):
    ...
    student_window = LogisticRegression(
...
print(f'\n   💡 INTERPRETAÇÃO:')
print(
    f'   Crise de 2008 alterou fundamentalmente as relações de risco de crédito:'
)
print(f'')
...
print(f'   Quebras detectadas:         {len(breaks)}')
print(
    f"   Principal quebra em:        {breaks[0]['date'].date() if breaks else 'N/A'}"
)
...
print(
    f'   Interpretação:              Crise aumentou sensibilidade a endividamento'
)
...
print('\n💡 PRÓXIMOS PASSOS:')
print(
    '   Execute 05_complete_demo.py para demo completo integrando todos componentes'
)
print('=' * 70)
