...
class TemplateManager:
    ...
    def _add_safe_filters(self, env):
        ...
        def safe_float(value, default=0.0):
            ...
            if isinstance(value, str):
                ...
                if (
                    ...
                    or 'classification' in value.lower()
                ):
                    return default
                try:
        ...
        env.filters['abs_value'] = (
            lambda x: abs(safe_float(x)) if x is not None else 0.0
        )
    ...
    def _find_template_cached(self, template_paths: tuple) -> str:
        ...
        **Phase 3 Sprint 9:** Cached to avoid repeated os.path.exists() calls.
        ...
        raise FileNotFoundError(
            f'Template not found at any of the specified paths:\n  - {paths_str}'
        )
    ...
    def get_template_paths(
        self, test_type: str, report_type: str = 'interactive'
    ) -> List[str]:
        """
        ...
        **Phase 3 Sprint 9:** Cached to avoid rebuilding paths for same test_type/report_type.
        ...
        if report_type == 'static':
            return [
                ...
                os.path.join(
                    self.templates_dir,
                    f'report_types/{test_type}/static/index.html',
                ),
                # Fallback to default template if static not found
                os.path.join(
                    self.templates_dir, f'report_types/{test_type}/index.html'
                ),
            ]
        else:
            return [
    ...
    def load_template(self, template_path: str):
        ...
        loader = self.jinja2.FileSystemLoader(
            [template_dir, self.templates_dir], encoding='utf-8'
        )
