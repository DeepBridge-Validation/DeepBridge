...
⚠️ DEPRECATED: This renderer is deprecated. Use the new unified API:
...
warnings.warn(
    "RobustnessRendererSimple is deprecated. Use ReportGenerator with ReportStyle.SIMPLE instead.",
    DeprecationWarning,
    stacklevel=2
)
