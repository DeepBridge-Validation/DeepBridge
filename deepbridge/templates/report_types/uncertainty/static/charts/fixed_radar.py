        ...
        try:
            if hasattr(base_generator, 'metrics_radar_chart'):
                ...
                try:
                    ...
                    logger.info(
                        f'Found metrics_radar_chart method with parameters: {param_names}'
                    )

                    # Try calling with models_metrics parameter
                    if 'models_metrics' in param_names:
                        logger.info(
                            'Calling metrics_radar_chart with models_metrics parameter'
                        )
                        chart = base_generator.metrics_radar_chart(
                    ...
                    # Try with different parameter names that might be used
                        ...
                        logger.info(
                            'Calling metrics_radar_chart with metrics_data parameter'
                        )
                        chart = base_generator.metrics_radar_chart(
                        ...
                        logger.info(
                            'Calling metrics_radar_chart with data parameter'
                        )
                        chart = base_generator.metrics_radar_chart(
                            data=metrics
                        )
                    ...
                    # Use positional parameter as last resort
                        ...
                        logger.info(
                            'Calling metrics_radar_chart with positional parameter'
                        )
                        chart = base_generator.metrics_radar_chart(metrics)
                        return chart
                except Exception as e:
                    logger.error(
                        f'Error calling metrics_radar_chart: {str(e)}'
                    )
                    logger.error(traceback.format_exc())
            else:
                logger.error(
                    'Base generator does not have metrics_radar_chart method'
                )
        except Exception as e:
            logger.error(
                f'Error during metrics_radar_chart method check: {str(e)}'
            )
            logger.error(traceback.format_exc())
...
def patch_enhanced_charts():
    ...
    try:
        ...
        EnhancedUncertaintyCharts.generate_model_metrics_comparison = (
            new_generate_model_metrics_comparison
        )
        logger.info(
            'Successfully patched EnhancedUncertaintyCharts.generate_model_metrics_comparison'
        )
        return True
    except Exception as e:
