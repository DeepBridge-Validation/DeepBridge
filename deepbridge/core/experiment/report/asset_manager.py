...
class AssetManager:
    ...
    def _validate_core_directories(self):
        ...
        """
        core_dirs = {'assets': self.assets_dir, 'common': self.common_dir}
    ...
    def get_asset_path(self, report_type: str, asset_path: str) -> str:
        ...
        report_dir = os.path.join(
            self.templates_dir, 'report_types', report_type
        )
    ...
    def transform_data(
        self, test_type: str, data: Dict[str, Any], model_name: str
    ) -> Dict[str, Any]:
    ...
    def write_json_data_file(
        ...
        return self.file_manager.write_json_data_file(
            data, output_dir, filename
        )
