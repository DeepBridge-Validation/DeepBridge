...
class UncertaintyRendererSimple(BaseRenderer):
    ...
    def __init__(self, template_manager, asset_manager):
        ...
        from ..transformers.uncertainty_simple import (
    ...
    def render(
        ...
        try:
            ...
            context = self._create_base_context(
                report_data, 'uncertainty', assets
            )
            ...
            context.update(
                {
                    ...
                    'base_score': report_data['summary'].get(
                        'base_score', 0.0
                    ),
                    'uncertainty_score': report_data['summary'][
                        'uncertainty_score'
                    ],
                    ...
                    'calibration_error': report_data['summary'].get(
                        'calibration_error',
                        report_data['summary']['avg_coverage_error'],
                    ),
                    'avg_coverage_error': report_data['summary'][
                        'avg_coverage_error'
                    ],
