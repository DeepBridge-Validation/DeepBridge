...
class DataManager:
    ...
    def prepare_data(self) -> None:
        ...
        if (
            hasattr(self.dataset, 'original_prob')
            and self.dataset.original_prob is not None
        ):
    ...
    def get_binary_predictions(
        self, probabilities: pd.DataFrame, threshold: float = 0.5
    ) -> pd.Series:
        """
