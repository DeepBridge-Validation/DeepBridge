...
class StaticResilienceRenderer:
    ...
    def __init__(self, template_manager, asset_manager):
        ...
        try:
            ...
            from templates.report_types.resilience.static.charts import (
            ...
            logger.info(
                'Successfully loaded resilience-specific chart generator from new location'
            )
            ...
            logger.error(
                f'New resilience chart generator not available: {str(e)}'
            )
            logger.error(f'Traceback: {traceback.format_exc()}')
            ...
            try:
                ...
                logger.info(
                    'Falling back to original resilience chart generator'
                )
                ...
                if self.resilience_chart_generator:
                    ...
                    logger.info(
                        f'Available resilience chart methods from fallback: {resilience_methods}'
                    )
            except ImportError:
