...
class TestHPMIntegration(unittest.TestCase):
    ...
    def test_shared_memory_warm_start(self):
        ...
        from deepbridge.distillation.techniques.hpm import SharedOptimizationMemory
    ...
    def test_temperature_scheduler_adaptation(self):
        ...
        from deepbridge.distillation.techniques.hpm import MetaTemperatureScheduler
