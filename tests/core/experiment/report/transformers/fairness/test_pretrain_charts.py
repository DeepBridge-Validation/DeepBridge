...
class TestPretrainMetricsOverviewChart:
    ...
    def test_create_with_valid_data(self, sample_pretrain_metrics, sample_protected_attrs, plotly_validator):
    ...
    def test_includes_all_four_pretrain_metrics(self, sample_protected_attrs, plotly_validator):
        ...
        assert plotly_validator(result), "Should create chart with all 4 metrics"
    ...
    def test_handles_multiple_attributes(self, plotly_validator):
        ...
        metrics = {
            ...
            'race': {
                'class_balance': {'value': 0.08, 'interpretation': '✗ CRITICAL'}
            }
        }
...
class TestGroupSizesChart:
    ...
    def test_displays_counts_and_percentages(self, sample_protected_attrs, plotly_validator):
        ...
        assert plotly_validator(result), "Should display counts and percentages"
...
class TestConceptBalanceChart:
    ...
    def test_create_without_concept_balance_metric(self, sample_protected_attrs):
        ...
        assert result == '{}', "Should return empty JSON when concept_balance is missing"

    def test_compares_group_positive_rates(self, sample_protected_attrs, plotly_validator):
