...
class TestChartRegistration:
    ...
    def test_all_uncertainty_charts_registered(self):
        ...
        for chart_name in uncertainty_charts:
            assert ChartRegistry.is_registered(chart_name), \
...
class TestUncertaintyCharts:
    ...
    def test_width_vs_coverage_generation(self, width_coverage_data):
        ...
        result = ChartRegistry.generate('width_vs_coverage', width_coverage_data)
    ...
    def test_calibration_error_generation(self, calibration_error_data):
        ...
        result = ChartRegistry.generate('calibration_error', calibration_error_data)
    ...
    def test_width_vs_coverage_with_title(self, width_coverage_data):
        ...
        assert result.is_success
        assert 'Custom Title' in result.content or result.metadata.get('title') == 'Custom Title'
...
class TestRobustnessCharts:
    ...
    def test_perturbation_impact_generation(self, perturbation_data):
        ...
        result = ChartRegistry.generate('perturbation_impact', perturbation_data)
    ...
    def test_feature_robustness_generation(self, feature_robustness_data):
        ...
        result = ChartRegistry.generate('feature_robustness', feature_robustness_data)
...
class TestGeneralPurposeCharts:
    ...
    def test_model_comparison_generation(self, model_comparison_data):
        ...
        result = ChartRegistry.generate('model_comparison', model_comparison_data)
    ...
    def test_interval_boxplot_generation(self, interval_boxplot_data):
        ...
        result = ChartRegistry.generate('interval_boxplot', interval_boxplot_data)
...
class TestStaticImageCharts:
    ...
    def test_width_vs_coverage_static_generation(self, width_coverage_data):
        ...
        result = ChartRegistry.generate('width_vs_coverage_static', width_coverage_data)
    ...
    def test_perturbation_impact_static_generation(self, perturbation_data):
        ...
        result = ChartRegistry.generate('perturbation_impact_static', perturbation_data)
...
class TestChartIntegration:
    ...
    def test_generate_all_uncertainty_charts(
        self, uncertainty_coverage_data, width_coverage_data,
        calibration_error_data, alternative_methods_data
    ):
    ...
    def test_mixed_plotly_and_static(self, width_coverage_data):
        ...
        plotly_result = ChartRegistry.generate('width_vs_coverage', width_coverage_data)
        static_result = ChartRegistry.generate('width_vs_coverage_static', width_coverage_data)
