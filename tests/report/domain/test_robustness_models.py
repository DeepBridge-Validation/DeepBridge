...
class TestRobustnessMetrics:
    ...
    def test_degradation_rate_property(self):
        ...
        metrics = RobustnessMetrics(base_score=0.80, avg_overall_impact=0.16)
...
class TestFeatureRobustnessData:
    ...
    def test_create_feature_data(self):
        ...
        feature = FeatureRobustnessData(
            name='feature1', importance=0.8, robustness_impact=0.3
        )
    ...
    def test_is_sensitive_property(self):
        ...
        sensitive = FeatureRobustnessData(name='f1', robustness_impact=0.25)
        not_sensitive = FeatureRobustnessData(
            name='f2', robustness_impact=0.15
        )
...
class TestRobustnessReportData:
    ...
    def test_create_minimal_report(self):
        ...
        report = RobustnessReportData(model_name='TestModel')
    ...
    def test_create_complete_report(self):
        ...
        report = RobustnessReportData(
            ...
            metrics=RobustnessMetrics(
                base_score=0.85, robustness_score=0.75, avg_overall_impact=0.10
            ),
            perturbation_levels=[
            ...
            features=[
                FeatureRobustnessData(
                    name='f1', importance=0.8, robustness_impact=0.2
                ),
                FeatureRobustnessData(
                    name='f2', importance=0.6, robustness_impact=0.3
                ),
            ],
            n_iterations=20,
        )
    ...
    def test_property_has_feature_data(self):
        ...
        with_data = RobustnessReportData(
            model_name='Test', features=[FeatureRobustnessData(name='f1')]
        )
    ...
    def test_property_most_sensitive_features(self):
        ...
        report = RobustnessReportData(
            ...
            features=[
                FeatureRobustnessData(
                    name='f1', importance=0.9, robustness_impact=0.1
                ),
                FeatureRobustnessData(
                    name='f2', importance=0.8, robustness_impact=0.5
                ),  # Most sensitive
                FeatureRobustnessData(
                    name='f3', importance=0.7, robustness_impact=0.3
                ),
            ],
        )
...
class TestDomainModelBenefits:
    ...
    def test_type_safety_no_get_calls(self):
        ...
        report = RobustnessReportData(
            model_name='Test',
            metrics=RobustnessMetrics(robustness_score=0.75, base_score=0.85),
        )
