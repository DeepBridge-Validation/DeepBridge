...
class TestUncertaintyMetrics:
    ...
    def test_none_coerced_to_default(self):
        ...
        metrics = UncertaintyMetrics(uncertainty_score=None, coverage=None)
    ...
    def test_calibration_error_auto_computed(self):
        ...
        metrics = UncertaintyMetrics(coverage=0.85, expected_coverage=0.90)

        assert metrics.calibration_error == pytest.approx(0.05, abs=1e-6)

    def test_float_rounding(self):
        """Test that floats are rounded to 4 decimals."""
        metrics = UncertaintyMetrics(uncertainty_score=0.123456789)
...
class TestAlternativeModelData:
    ...
    def test_is_better_than_property(self):
        ...
        good_model = AlternativeModelData(name='Good', uncertainty_score=0.75)

        bad_model = AlternativeModelData(name='Bad', uncertainty_score=0.30)
...
class TestUncertaintyReportData:
    ...
    def test_create_minimal_report(self):
        ...
        report = UncertaintyReportData(
            model_name='TestModel', timestamp='2025-11-05T10:00:00'
        )
    ...
    def test_create_complete_report(self):
        ...
        report = UncertaintyReportData(
            ...
            metrics=UncertaintyMetrics(
                uncertainty_score=0.85, coverage=0.90, mean_width=0.15
            ),
            ...
            alternative_models={
                'mc_dropout': AlternativeModelData(
                    name='MC Dropout', uncertainty_score=0.78
                )
            },
            dataset_size=1000,
        )
    ...
    def test_property_has_alternative_models(self):
        ...
        report = UncertaintyReportData(
            model_name='Test', timestamp='2025-11-05'
        )

        assert not report.has_alternative_models

        report.alternative_models['method1'] = AlternativeModelData(
            name='Method1'
        )
    ...
    def test_str_representation(self):
        ...
        report = UncertaintyReportData(
            ...
            timestamp='2025-11-05',
            metrics=UncertaintyMetrics(
                uncertainty_score=0.85, coverage=0.90, calibration_error=0.05
            ),
        )
    ...
    def test_type_safety_no_get_calls(self):
        ...
        report = UncertaintyReportData(
            model_name='Test',
            timestamp='2025-11-05',
            metrics=UncertaintyMetrics(uncertainty_score=0.85, coverage=0.90),
        )
...
class TestDomainModelBenefits:
    ...
    def test_eliminates_isinstance_checks(self):
        ...
        has_alternatives_old = 'alternative_models' in old_data and isinstance(
            old_data['alternative_models'], dict
        )
        ...
        report = UncertaintyReportData(
            model_name='Test',
            timestamp='2025-11-05',
            alternative_models={'method1': AlternativeModelData(name='Test')},
        )
